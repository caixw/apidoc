...
func TestBuild(t *testing.T) {
	...
	schema := &Schema{}
	a.NotError(Build(tag, schema, nil, []byte("object"), requiredBytes, []byte("desc")))
	a.Equal(schema.Type, "object")

	schema = &Schema{}
	a.NotError(Build(tag, schema, []byte("array"), []byte("array.object"), []byte("required"), []byte("desc")))
	...
	schema = &Schema{}
	a.NotError(Build(tag, schema, []byte("obj.array"), []byte("array.object"), requiredBytes, []byte("desc")))
